...
Hidden Layers: Two dense layers with ReLU activation and Dropout (0.3) to prevent overfitting.
...
Machine Learning: Scikit-Learn (MinMaxScaler, OneHotEncoder)
...
├── models/             # Saved model weights (best_model.pt) & Scalers
...
Run Inference: python -m src.predict